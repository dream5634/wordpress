...
<?php if (is_active_sidebar('first-footer-widget-area') && $class1!='' ) : ?>
    <div id="first" class="widget-area <?php echo esc_attr($class1);?> ">
        <ul class="xoxo">
...
<?php if (is_active_sidebar('second-footer-widget-area') && $class2!='' ) : ?>
    <div id="second" class="widget-area <?php echo esc_attr($class2);?>">
        <ul class="xoxo">
...
<?php if (is_active_sidebar('third-footer-widget-area') && $class3!='') : ?>
    <div id="third" class="widget-area <?php echo esc_attr($class3);?>">
        <ul class="xoxo">
...
<?php if ( is_active_sidebar('fourth-footer-widget-area') && $class4!='' ) : ?>
    <div id="fourth" class="widget-area <?php echo esc_attr($class4);?>">
        <ul class="xoxo">
