...
if ($post_attachments || has_post_thumbnail() ) { 
        ...
        foreach ($post_attachments as $attachment) {
            ...
            $slides .= '<div class="item" >
                            <a href="'.esc_url($full_prty[0]).'" title="'.esc_html($attachment_meta['caption']).'" rel="prettyPhoto" class="prettygalery" > 
                                <img  src="'.esc_url($full_img[0]).'"  alt="'.esc_attr($attachment_meta['alt']).'" class="img-responsive lightbox_trigger" />
                             </a>
                             <span class="item-caption">'.esc_html($attachment_meta['caption']).'</span>
                        </div>';
        ...
        <div class="row_slider">
            ...
            <div class="col-md-9">
                <?php echo'  <div id="carousel-listing" class="carouselvertical">'.$slides.'</div>'; //escaped above ?>
                <?php  echo' <div id="carousel-listing-nav" class="carouselvertical-nav" >'. $slides_minor.'</div>'; //escaped above ?>
