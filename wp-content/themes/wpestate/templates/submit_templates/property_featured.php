...
if ( ( $paid_submission_status == 'membership' && wpestate_get_remain_featured_listing_user($userID)>0 )){ ?>  
    ...
    <div class="submit_container_header"><?php  esc_html_e('Featured Submission','wpestate');?></div>
    <div class="user_dashboard_box">
        <p class="meta-options full_form-nob"> 
          <?php esc_html_e('Make this listing featured from property list.','wpestate')?>
        </p> 
    </div>
    </div>
<?php 
